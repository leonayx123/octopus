...
public class DESUtil {
    ...
    /** 默认安全密钥 */
    private String keyData = "ABCDEFGHIJKLMNOPQRSTWXYZabcdefghijklmnopqrstwxyz0123456789";
    ...
    public static void main(String args[]){
        ...
        try {
            DESUtil util=new DESUtil("1234abcD");
            String key=  util.encrypt("123456yx132");
            System.out.println(key);

            DESUtil util2=new DESUtil("ABCDEFGpqrstwxyz");
            String key2=  util2.encrypt("123456yx132");
            System.out.println(key2);

            DESUtil util3=new DESUtil();
            String key3=  util3.encrypt("123456yx132");
